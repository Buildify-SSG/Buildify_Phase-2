...
public class AdminDashboardControllerImpl implements AdminDashboardController{
    ...
    // MODEL로 JSP에 토스
    @Override
    public List<InboundDTO> dashboardInbound(Model model) {
        return null;
    }
    ...
    // MODEL로 JSP에 토스
    @Override
    public List<OutboundDTO> dashboardOutbound(Model model) {
        return null;
    }
    ...
    // return 리스트 size
    @Override
    public List<UserDTO> dashboardUserStatus(Model model) {
        return null;
    }
}
