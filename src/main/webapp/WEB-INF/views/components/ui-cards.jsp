	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="../adminpractice/index.html">
          <span class="align-middle">AdminKit</span>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="../adminpractice/index.html">
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dashboard</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="../pages-inbound.html">
              <i class="align-middle" data-feather="user"></i> <span class="align-middle">Profile</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="pages-sign-in.jsp">
              <i class="align-middle" data-feather="log-in"></i> <span class="align-middle">Sign In</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="pages-sign-up.jsp">
              ...
              <i class="align-middle" data-feather="book"></i> <span class="align-middle">Blank</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="ui-buttons.jsp">
              <i class="align-middle" data-feather="square"></i> <span class="align-middle">Buttons</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="ui-forms.jsp">
              ...
              <i class="align-middle" data-feather="grid"></i> <span class="align-middle">Cards</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="ui-typography.jsp">
              ...
              <i class="align-middle" data-feather="map"></i> <span class="align-middle">Maps</span>
				...
				<div class="sidebar-cta">
					<div class="sidebar-cta-content">
						...
						<div class="d-grid">
							<a href="upgrade-to-pro.jsp" class="btn btn-primary">Upgrade to Pro</a>
						</div>
					</div>
				</div>
			</div>
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="../../static/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Charles Hall</span>
							...
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="../pages-inbound.html"><i class="align-middle me-1" data-feather="user"></i> Profile</a>
								<a class="dropdown-item" href="#"><i class="align-middle me-1" data-feather="pie-chart"></i> Analytics</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="../adminpractice/index.html"><i class="align-middle me-1" data-feather="settings"></i> Settings & Privacy</a>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						...
						<a class="badge bg-dark text-white ms-2" href="upgrade-to-pro.jsp">
      Get more card examples
					...
					<div class="row">
						<div class="col-12 col-md-6">
							<div class="card">
								<img class="card-img-top" src="../../static/img/photos/unsplash-1.jpg" alt="Unsplash">
						...
						<div class="col-12 col-md-6">
							<div class="card">
								<img class="card-img-top" src="../../static/img/photos/unsplash-2.jpg" alt="Unsplash">
								<div class="card-header">
