...
<div style="padding: 20px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
        <!-- 검색 영역 -->
        <form method="get" action="/admin/pages/inventory/inventory-2/search">
    ...
    <div class="table-wrapper">
        <form method="GET" action="/admin/pages/inventory/inventory-2">
...
<script>
    function confirmDelete() {
        ...
        if (confirmed) {
            document.querySelector('form[action="/admin/pages/inventory/inventory-2/api/productRemove"]').submit();
        }
    }
</script>
